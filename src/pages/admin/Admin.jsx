...
const AdminPage = () => {
  ...
  const handleFoodSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://localhost:3000/api/admin/create/food-item', foodItem);
  ...
  const handleDeleteFood = async (id) => {
    ...
    try {
      await axios.delete(`http://localhost:3000/api/admin/food-item/${id}`);
  ...
  const handleProductSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://localhost:3000/api/admin/create/product', product);
